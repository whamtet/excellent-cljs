...
if(cljs.core.truth_(clojure.zip.branch_QMARK_.call(null,loc)))
{var vec__4637 = loc;
var node = cljs.core.nth.call(null,vec__4637,0,null);
var path = cljs.core.nth.call(null,vec__4637,1,null);
var vec__4638 = clojure.zip.children.call(null,loc);
var c = cljs.core.nth.call(null,vec__4638,0,null);
var cnext = cljs.core.nthnext.call(null,vec__4638,1);
var cs = vec__4638;
...
var vec__4641 = loc;
var node = cljs.core.nth.call(null,vec__4641,0,null);
var map__4642 = cljs.core.nth.call(null,vec__4641,1,null);
var map__4642__$1 = ((cljs.core.seq_QMARK_.call(null,map__4642))?cljs.core.apply.call(null,cljs.core.hash_map,map__4642):map__4642);
var path = map__4642__$1;
var l = cljs.core.get.call(null,map__4642__$1,"\uFDD0:l");
var ppath = cljs.core.get.call(null,map__4642__$1,"\uFDD0:ppath");
var pnodes = cljs.core.get.call(null,map__4642__$1,"\uFDD0:pnodes");
var r = cljs.core.get.call(null,map__4642__$1,"\uFDD0:r");
var changed_QMARK_ = cljs.core.get.call(null,map__4642__$1,"\uFDD0:changed?");
...
var vec__4647 = loc;
var node = cljs.core.nth.call(null,vec__4647,0,null);
var map__4648 = cljs.core.nth.call(null,vec__4647,1,null);
...
var path = map__4648__$1;
var l = cljs.core.get.call(null,map__4648__$1,"\uFDD0:l");
var vec__4649 = cljs.core.get.call(null,map__4648__$1,"\uFDD0:r");
var r = cljs.core.nth.call(null,vec__4649,0,null);
var rnext = cljs.core.nthnext.call(null,vec__4649,1);
var rs = vec__4649;
...
var vec__4652 = loc;
var node = cljs.core.nth.call(null,vec__4652,0,null);
var map__4653 = cljs.core.nth.call(null,vec__4652,1,null);
...
var path = map__4653__$1;
var l = cljs.core.get.call(null,map__4653__$1,"\uFDD0:l");
var r = cljs.core.get.call(null,map__4653__$1,"\uFDD0:r");
if(cljs.core.truth_((function (){var and__3941__auto__ = path;
if(cljs.core.truth_(and__3941__auto__))
{return r;
} else
...
var vec__4656 = loc;
var node = cljs.core.nth.call(null,vec__4656,0,null);
var map__4657 = cljs.core.nth.call(null,vec__4656,1,null);
...
var path = map__4657__$1;
var l = cljs.core.get.call(null,map__4657__$1,"\uFDD0:l");
var r = cljs.core.get.call(null,map__4657__$1,"\uFDD0:r");
if(cljs.core.truth_((function (){var and__3941__auto__ = path;
if(cljs.core.truth_(and__3941__auto__))
...
var vec__4660 = loc;
var node = cljs.core.nth.call(null,vec__4660,0,null);
var map__4661 = cljs.core.nth.call(null,vec__4660,1,null);
var map__4661__$1 = ((cljs.core.seq_QMARK_.call(null,map__4661))?cljs.core.apply.call(null,cljs.core.hash_map,map__4661):map__4661);
var path = map__4661__$1;
var l = cljs.core.get.call(null,map__4661__$1,"\uFDD0:l");
var r = cljs.core.get.call(null,map__4661__$1,"\uFDD0:r");
if(cljs.core.truth_((function (){var and__3941__auto__ = path;
if(cljs.core.truth_(and__3941__auto__))
{return cljs.core.seq.call(null,l);
} else
...
var vec__4664 = loc;
var node = cljs.core.nth.call(null,vec__4664,0,null);
var map__4665 = cljs.core.nth.call(null,vec__4664,1,null);
var map__4665__$1 = ((cljs.core.seq_QMARK_.call(null,map__4665))?cljs.core.apply.call(null,cljs.core.hash_map,map__4665):map__4665);
var path = map__4665__$1;
var l = cljs.core.get.call(null,map__4665__$1,"\uFDD0:l");
if((path == null))
{throw "Insert at top";
} else
...
var vec__4668 = loc;
var node = cljs.core.nth.call(null,vec__4668,0,null);
var map__4669 = cljs.core.nth.call(null,vec__4668,1,null);
...
var path = map__4669__$1;
var r = cljs.core.get.call(null,map__4669__$1,"\uFDD0:r");
if((path == null))
{throw "Insert at top";
} else
...
var path = cljs.core.nth.call(null,vec__4671,1,null);
...
edit.cljs$lang$applyTo = (function (arglist__4672){
var loc = cljs.core.first(arglist__4672);
arglist__4672 = cljs.core.next(arglist__4672);
var f = cljs.core.first(arglist__4672);
var args = cljs.core.rest(arglist__4672);
...
{{
var G__4673 = clojure.zip.up.call(null,p);
p = G__4673;
continue;
}
}
...
{
var G__4674 = clojure.zip.rightmost.call(null,child);
loc__$1 = G__4674;
continue;
}
} else
...
var vec__4677 = loc;
var node = cljs.core.nth.call(null,vec__4677,0,null);
var map__4678 = cljs.core.nth.call(null,vec__4677,1,null);
var map__4678__$1 = ((cljs.core.seq_QMARK_.call(null,map__4678))?cljs.core.apply.call(null,cljs.core.hash_map,map__4678):map__4678);
var path = map__4678__$1;
var l = cljs.core.get.call(null,map__4678__$1,"\uFDD0:l");
var ppath = cljs.core.get.call(null,map__4678__$1,"\uFDD0:ppath");
var pnodes = cljs.core.get.call(null,map__4678__$1,"\uFDD0:pnodes");
var rs = cljs.core.get.call(null,map__4678__$1,"\uFDD0:r");
if((path == null))
{throw "Remove at top";
} else
...
{
var G__4679 = clojure.zip.rightmost.call(null,child);
loc__$1 = G__4679;
continue;
}
} else
