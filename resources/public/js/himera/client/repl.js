...
return cljs.core.reset_BANG_.call(null,data,p1__3551_SHARP_);
});})(data))
], true));
jQuery.ajax(params);
...
return cljs.core.reset_BANG_.call(null,data,p1__3552_SHARP_);
});})(data))
], true));
jQuery.ajax(params);
return cljs.core.deref.call(null,data);
...
himera.client.repl.is_comment_QMARK_ = (function is_comment_QMARK_(p1__3553_SHARP_){
return himera.client.repl.starts_with_QMARK_.call(null,";",p1__3553_SHARP_);
});
...
}catch (e3555){if((e3555 instanceof Error))
{var e = e3555;
...
return controller = (function (){var G__3557 = jQuery("#console");
G__3557.console(himera.client.repl.map__GT_js.call(null,cljs.core.PersistentArrayMap.fromArray(["\uFDD0:welcomeMessage","Excellent REPL v0.2.5","\uFDD0:promptLabel","go buddy> ","\uFDD0:commandValidate",himera.client.repl.on_validate,"\uFDD0:commandHandle",himera.client.repl.on_handle,"\uFDD0:autofocus",true,"\uFDD0:animateScroll",true,"\uFDD0:promptHistory",true], true)));
return G__3557;
})();
}));
});
